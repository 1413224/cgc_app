<template>
	<div class="order_review_box">
		<settingHeader title="发表追评"></settingHeader>
		<div class="input_box">
			<div class="top">
			...
			<ul class="photo_box">
				<li v-for="(img,i) in imgsList" :key="index">
					<img @click="preview(index,i,imgsList)" :src="img">
				</li>
			</ul>
		</div>
		...
		<div class="zp_box">
			...
			<x-textarea class="textarea_box" :max="200" placeholder="分享你的购买心得" v-model="textValue"></x-textarea>
			<ul class="photo_box">
